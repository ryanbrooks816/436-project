...
<head>
    ...
    <title><?php echo htmlspecialchars($game['game_name'] ?? 'Game Details'); ?> - Accessible Games Database</title>
    ...
    <div class="container mt-4 mb-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><?php echo htmlspecialchars($game['game_name'] ?? 'Game Details'); ?></li>
            </ol>
        </nav>
        ...
        <?php elseif ($game): ?>
            <div class="game-container">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card mb-4">
                            <img src="images/placeholder.jpg" class="card-img-top" alt="Image for <?php echo htmlspecialchars($game['game_name']); ?>">
                            <div class="card-body">
                                <h5>Game Information</h5>
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        <strong>Publisher:</strong> <?php echo htmlspecialchars($game['publisher_name'] ?? 'Unknown'); ?>
                                    </li>
                                    <li class="list-group-item">
                                        <strong>Release Date:</strong> <?php echo htmlspecialchars($game['game_release_date'] ?? 'Unknown'); ?>
                                    </li>
                                    <li class="list-group-item">
                                        <strong>Rating:</strong> <?php echo htmlspecialchars($game['game_rating'] ?? 'N/A'); ?>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <iframe src="Game Descriptions.pdf#search=<?php echo urlencode($game['game_name']); ?>" class="pdf-viewer"></iframe>
                            </div>
                        </div>
                                ...
                                <?php else: ?>
                                    <div>
                                        <?php foreach ($platforms as $platform): ?>
                                            <span class="platform-badge"><?php echo htmlspecialchars($platform['platform_name']); ?></span>
                                        <?php endforeach; ?>
                                    </div>
                                <?php endif; ?>
                            </div>
