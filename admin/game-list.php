...
<div class="container py-5">
    ...
    <?php else: ?>
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
            <?php foreach ($games as $game): ?>
                <div class="col">
                    <a href="/436-project/admin/game-view.php?game_id=<?= urlencode($game['game_id']) ?>"
    ...
    <a href="/436-project/admin/dashboard.php"
        class="btn btn-outline-secondary position-fixed start-0 bottom-0 m-4 shadow rounded-pill"
        style="width: 140px; height: 50px; font-weight: bold; text-align: center; line-height: 2.2;">
        Home
    </a>

    <a href="/436-project/admin/game-create.php"
        class="btn btn-success position-fixed bottom-0 end-0 m-4 shadow rounded-circle" title="Add New Game"
        style="width: 60px; height: 60px; font-size: 24px; text-align: center; line-height: 1.8;">
        +
    </a>
</div>
