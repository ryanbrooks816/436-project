<div
    ...
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-2">
            ...
            <div>
                <span
                    class="status-badge status-<?= strtolower(htmlspecialchars($ticket['status'])); ?> me-2"><?= ucfirst(htmlspecialchars($ticket['status'])); ?></span>
                <span
        ...
        <div class="d-flex justify-content-between mb-3">
            <div>
                <span class="text-muted me-3"><i class="fas fa-folder"></i>
                    <?php
