<div
    class="ticket-card card my-4 shadow-sm priority-<?= strtolower(htmlspecialchars($ticket['priority'])); ?> status-<?= strtolower(str_replace(' ', '-', htmlspecialchars($ticket['status']))); ?>">
    <div class="card-body">
